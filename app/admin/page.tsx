...
// Horários de trabalho padrão da barbearia
...
export default function Home() {
  ...
  const handleAgendar = async () => {
    ...
    if (error) {
      ...
      const dataBr = `${partesData[2]}/${partesData[1]}/${partesData[0]}`; // Fica no padrão Brasil (DD/MM/AAAA)
      
      // Monta o textinho bonito pro WhatsApp
